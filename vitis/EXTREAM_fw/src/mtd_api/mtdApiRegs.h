...
#define MTD_TUNIT_TEMP_SENSOR          MTD_T_UNIT_PCS_CU,0x8043
...
#define MTD_CUNIT_TEMP_SENSOR_CTRL     MTD_C_UNIT_GENERAL,0xF08A
#define MTD_CUNIT_TEMP_SENSOR          MTD_C_UNIT_GENERAL,0xF08C
