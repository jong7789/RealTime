...
#define MTD_E21X0_BASE (0x1B<<4)   /* whether the device uses E21X0 firmware base, this is a max 5G part, copper only, no Macsec/PTP */
...
#define MTD_E21X0BASE_SINGLE_PORTZ1 0x8
#define MTD_E21X0BASE_QUAD_PORTA0   0x4
#define MTD_E21X0BASE_OCTAL_PORTA0  0x0
...
typedef enum
{
    ...
    MTD_REV_E2140_A0 = (MTD_E21X0_BASE | MTD_COPPER_CAPABLE | MTD_E21X0BASE_QUAD_PORTA0),
