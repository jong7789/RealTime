...
/******************************************************************************
 ...
 Description:
    ...
    in devPtr->deviceId if needed.

 Side effects:
    None

 Notes/Warnings:
    For E21X0, the T Unit temperature sensor is enabled in firmware.
    This function is ignored on E21X0. The sensor is shared with the firmware.
...
/******************************************************************************
 ...
 Outputs:
    temperature - Read out average value of the temperature sensor in Celsius.
                  ...
                  The temperature sampling average time is every 1 second.
 ...
 Notes/Warnings:
    ...
    Please wait at least 2 seconds after the temperature sensor is enabled 
