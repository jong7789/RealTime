...
#define MTD_MAC_TYPE_5BR_SGMII_AN_EN    (0x4) /* 5GBASE-R/2500BASE-X/SGMII AN En for 1G and below NOTE: not valid on E2110 */
...
/******************************************************************************
 ...
 Inputs:
    ...
    macType - the type of MAC interface being used (the hardware interface). 
        ...
        MTD_MAC_TYPE_5BR_SGMII_AN_EN - 5GBASE-R/2500BASE-X/SGMII AN En for 1G and below (not allowed on E2110)
