...
proc write_mig_file_cpu_sdram_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>cpu_mig_7series_0_0</ModuleName>}
...
proc create_root_design { parentCell } {
  ...
  set ext [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 ext ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {m0_axi_fb:m1_axi_gev:m2_axi_video} \
   CONFIG.ASSOCIATED_RESET {m0_axi_aresetn} \
 ] $sys_clk
  set sys_locked [ create_bd_port -dir O sys_locked ]
  ...
  connect_bd_intf_net -intf_net mig_7series_0_DDR3 [get_bd_intf_ports ddr3] [get_bd_intf_pins sdram_0/DDR3]
  connect_bd_intf_net -intf_net s0_axi_1 [get_bd_intf_ports s0_axi] [get_bd_intf_pins smartconnect_0/S02_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins sdram_0/S_AXI] [get_bd_intf_pins smartconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net sys_diff_clock_1 [get_bd_intf_ports ext] [get_bd_intf_pins sdram_0/SYS_CLK]
  connect_bd_intf_net -intf_net uartlite_0_UART [get_bd_intf_ports uart] [get_bd_intf_pins uartlite_0/UART]

  # Create port connections
  connect_bd_net -net clk_wiz_1_locked [get_bd_ports sys_locked] [get_bd_pins clk_wiz_1/locked] [get_bd_pins rst_clk_wiz_1_100M/dcm_locked]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_ports sys_clk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk1] [get_bd_pins uartlite_0/s_axi_aclk]
  ...
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_ports s0_axi_aclk] [get_bd_pins clk_wiz_1/clk_in1] [get_bd_pins rst_mig_7series_0_200M/slowest_sync_clk] [get_bd_pins sdram_0/ui_clk] [get_bd_pins smartconnect_0/aclk]
  connect_bd_net -net mig_7series_0_ui_clk_sync_rst [get_bd_pins rst_clk_wiz_1_100M/ext_reset_in] [get_bd_pins rst_mig_7series_0_200M/ext_reset_in] [get_bd_pins sdram_0/ui_clk_sync_rst]
  connect_bd_net -net reset_1 [get_bd_ports ext_rst] [get_bd_pins sdram_0/sys_rst]
  connect_bd_net -net rst_clk_wiz_1_100M_bus_struct_reset [get_bd_ports sys_rst] [get_bd_pins microblaze_0_local_memory/LMB_Rst] [get_bd_pins rst_clk_wiz_1_100M/bus_struct_reset]
  connect_bd_net -net rst_clk_wiz_1_100M_interconnect_aresetn [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins rst_clk_wiz_1_100M/interconnect_aresetn]
  connect_bd_net -net rst_clk_wiz_1_100M_mb_reset [get_bd_pins microblaze_0/Reset] [get_bd_pins microblaze_0_axi_intc/processor_rst] [get_bd_pins rst_clk_wiz_1_100M/mb_reset]
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_ports m0_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn] [get_bd_pins uartlite_0/s_axi_aresetn]
  connect_bd_net -net rst_mig_7series_0_200M_peripheral_aresetn [get_bd_ports s0_axi_aresetn] [get_bd_pins rst_mig_7series_0_200M/peripheral_aresetn] [get_bd_pins sdram_0/aresetn] [get_bd_pins smartconnect_0/aresetn]
