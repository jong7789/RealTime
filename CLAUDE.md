...
2. 작성한 VHDL 코드는 '--$ (오늘날짜) (변경 이유 1줄)' 주석을 영어로 작성 ex) --$ 260325 Add EXT3643R SFP Module
3. 작성한 FW 코드는 '//$ (오늘날짜) (변경 이유 1줄)' 주석을 영어로 작성
ex) //$ 260512 fix ROIC Timing
4. 신규 변수 선언 시 기존 변수 선언한 것 참고하여 통일성있게 작성
5. CDC 코드 작성 시 process 별도로 분리하여 작성
6. .vhd 코드만 수정하기 나머지 확장자는 수정하는 방법 가이드라인으로 제시
...
9. 8번에 맞추어 GIGE_DVER이랑 FW_DATE도 수정할것
    GIGE_DVER = SW2.xx.yy  => xx : SUB, yy:MAIN
    FW_DATA   = yyyy.mm.dd aa:bb => yyyy : 년도, mm : 월, dd : 일, aa : 시, bb : 분