...
# █▀▀ ▄▀█ ▀█▀ █▀▀
# █▄█ █▀█ ░█░ ██▄
set_property PACKAGE_PIN E21 [get_ports {GATE_SHIFT_CLK}]
set_property PACKAGE_PIN D21 [get_ports {GATE_START_PULSE1[11]}]
set_property PACKAGE_PIN E20 [get_ports {GATE_START_PULSE1[10]}]
set_property PACKAGE_PIN E22 [get_ports {GATE_START_PULSE1[9]}]
set_property PACKAGE_PIN F22 [get_ports {GATE_START_PULSE1[8]}]
set_property PACKAGE_PIN G22 [get_ports {GATE_START_PULSE1[7]}]
set_property PACKAGE_PIN H23 [get_ports {GATE_START_PULSE1[6]}]
set_property PACKAGE_PIN D25 [get_ports {GATE_START_PULSE1[5]}]
set_property PACKAGE_PIN D26 [get_ports {GATE_START_PULSE1[4]}]
set_property PACKAGE_PIN E25 [get_ports {GATE_START_PULSE1[3]}]
set_property PACKAGE_PIN E26 [get_ports {GATE_START_PULSE1[2]}]
set_property PACKAGE_PIN F25 [get_ports {GATE_START_PULSE1[1]}]
set_property PACKAGE_PIN G25 [get_ports {GATE_START_PULSE1[0]}]
set_property PACKAGE_PIN J26 [get_ports {GATE_START_PULSE2[0]}]
set_property PACKAGE_PIN B26 [get_ports {GATE_OUT_EN1}]
set_property PACKAGE_PIN C24 [get_ports {GATE_OUT_EN2}]
