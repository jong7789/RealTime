...
#set_property PACKAGE_PIN E23 [get_ports {GATE_START_PULSE1[5]}]; # F_DIO1_6
#set_property PACKAGE_PIN E26 [get_ports {GATE_START_PULSE1[4]}]; # F_DIO1_5
#set_property PACKAGE_PIN E25 [get_ports {GATE_START_PULSE1[3]}]; # F_DIO1_4
#set_property PACKAGE_PIN F25 [get_ports {GATE_START_PULSE1[2]}]; # F_DIO1_3
#set_property PACKAGE_PIN G25 [get_ports {GATE_START_PULSE1[1]}]; # F_DIO1_2
#set_property PACKAGE_PIN G26 [get_ports {GATE_START_PULSE1[0]}]; # F_DIO1_1
...
#set_property PACKAGE_PIN D23 [get_ports {GATE_START_PULSE2[5]}]; # F_DIO2_6
#set_property PACKAGE_PIN E22 [get_ports {GATE_START_PULSE2[4]}]; # F_DIO2_5
#set_property PACKAGE_PIN D21 [get_ports {GATE_START_PULSE2[3]}]; # F_DIO2_4
#set_property PACKAGE_PIN E20 [get_ports {GATE_START_PULSE2[2]}]; # F_DIO2_3
#set_property PACKAGE_PIN F22 [get_ports {GATE_START_PULSE2[1]}]; # F_DIO2_2
#set_property PACKAGE_PIN E21 [get_ports {GATE_START_PULSE2[0]}]; # F_DIO2_1
...
# start_pulse1 map reverse 0 to 5 211026mbh  220128mbh refix
