...
################################################################################
#set model_name "EXT2430RI"
#set_property -name CONSTANT [get_nets MODEL] $model_name
...
set_property PACKAGE_PIN F24 [get_ports { GATE_START_PULSE1[7]  }]; # DIO1 IO_L14N_T2_SRCC_14
set_property PACKAGE_PIN F23 [get_ports { GATE_START_PULSE1[6]  }]; # DIO1  IO_L13N_T2_MRCC_14
set_property PACKAGE_PIN E23 [get_ports { GATE_START_PULSE1[5]  }]; # DIO1  IO_L12N_T1_MRCC_14
set_property PACKAGE_PIN E22 [get_ports { GATE_START_PULSE1[4]  }]; # DIO1  IO_L9N_T1_DQS_D13_14
set_property PACKAGE_PIN D24 [get_ports { GATE_START_PULSE1[3]  }]; # DIO1  IO_L11N_T1_SRCC_14
set_property PACKAGE_PIN D23 [get_ports { GATE_START_PULSE1[2]  }]; # DIO1  IO_L11P_T1_SRCC_14
set_property PACKAGE_PIN G17 [get_ports { GATE_START_PULSE1[1]  }]; # DIO1  IO_L11P_T1_SRCC_AD12P_15
set_property PACKAGE_PIN G19 [get_ports { GATE_START_PULSE1[0]  }]; # DIO1  IO_L16P_T2_A28_15
...
set_property PACKAGE_PIN D21 [get_ports { GATE_START_PULSE2[7]  }]; # DIO2 IO_L7P_T1_D09_14
set_property PACKAGE_PIN C21 [get_ports { GATE_START_PULSE2[6]  }]; # DIO2 IO_L10P_T1_D14_14
set_property PACKAGE_PIN B21 [get_ports { GATE_START_PULSE2[5]  }]; # DIO2 IO_L10N_T1_D15_14
set_property PACKAGE_PIN G21 [get_ports { GATE_START_PULSE2[4]  }]; # DIO2 IO_L19N_T3_A09_D25_VREF_14
set_property PACKAGE_PIN H21 [get_ports { GATE_START_PULSE2[3]  }]; # DIO2 IO_L19P_T3_A10_D26_14
set_property PACKAGE_PIN J21 [get_ports { GATE_START_PULSE2[2]  }]; # DIO2 IO_L21P_T3_DQS_14
set_property PACKAGE_PIN D20 [get_ports { GATE_START_PULSE2[1]  }]; # DIO2 IO_L15N_T2_DQS_ADV_B_15
set_property PACKAGE_PIN D19 [get_ports { GATE_START_PULSE2[0]  }]; # DIO2 IO_L15P_T2_DQS_15
...
# set_property PACKAGE_PIN A8  [get_ports { READY_IN_C  }]; # IO_L9N_T1_DQS_16
...
# ETH PHY
set_property PACKAGE_PIN C11  [get_ports { PHY_#INTN   }]; # IO_L13N_T2_MRCC_16
...
set_property PACKAGE_PIN C12  [get_ports { PWR_EN[1] }]; # VBIAS_EN  IO_L13P_T2_MRCC_16
...
set_property PACKAGE_PIN E12  [get_ports { PWR_EN[7] }]; # R2_AVDD1_EN  IO_L18N_T2_16
set_property PACKAGE_PIN D13  [get_ports { PWR_EN[8] }]; # R2_AVDD2_EN  IO_L17N_T2_16
# FLASH
# set_property PACKAGE_PIN K22 [get_ports { FLASH_#RESET }]; # IO_L23N_T3_A02_D18_14
# set_property PACKAGE_PIN C8 [get_ports { FLASH_CLK  }]; # CCLK_0
...
# set_property PACKAGE_PIN C16 [get_ports { FLASH_2_#RESET }]; # IO_L1P_T0_AD0P_15
...
### ETH PHY
set_property IOSTANDARD LVCMOS33 [get_ports { PHY_#INTN  }]; # IO_L13N_T2_MRCC_16
...
# set_max_delay -to [get_pins SYNTH.G_rxaui_10G.RXAUI_INST/U0/rxaui_block_i/rxaui_cl_resets_i/reset156_r1_reg/S] 6.400
# set_max_delay -to [get_pins SYNTH.G_rxaui_10G.RXAUI_INST/U0/rxaui_block_i/rxaui_cl_resets_i/reset156_r2_reg/S] 6.400
# set_max_delay -to [get_pins SYNTH.G_rxaui_10G.RXAUI_INST/U0/rxaui_block_i/rxaui_cl_resets_i/reset156_r3_reg/S] 6.400
# set_property ASYNC_REG true [get_cells SYNTH.G_rxaui_10G.RXAUI_INST/U0/rxaui_block_i/rxaui_cl_resets_i/reset156_r1_reg]
# set_property ASYNC_REG true [get_cells SYNTH.G_rxaui_10G.RXAUI_INST/U0/rxaui_block_i/rxaui_cl_resets_i/reset156_r2_reg]
# set_property ASYNC_REG true [get_cells SYNTH.G_rxaui_10G.RXAUI_INST/U0/rxaui_block_i/rxaui_cl_resets_i/reset156_r3_reg]
...
# set_false_path -from [get_clocks SYNTH.G_rxaui_10G.RXAUI_INST/U0//rxaui_block_i/gt0_wrapper_i/gtxe2_i/TXOUTCLK] -to [get_clocks clk_out2_PLL_20M_100M_200M_250M]
# 
...
create_clock -period 5.000 [get_ports SYSTEM_CLK_P]
create_clock -period 4.167 -name VIRTUAL_clk_out2_cpu_clk_wiz_0_0 -waveform {0.000 2.083}
set_input_delay -clock [get_clocks VIRTUAL_clk_out2_cpu_clk_wiz_0_0] -clock_fall -min -add_delay 0.000 [get_ports {ROIC_DOUT_N[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_out2_cpu_clk_wiz_0_0] -clock_fall -max -add_delay 1.000 [get_ports {ROIC_DOUT_N[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_out2_cpu_clk_wiz_0_0] -min -add_delay 0.000 [get_ports {ROIC_DOUT_N[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_out2_cpu_clk_wiz_0_0] -max -add_delay 1.000 [get_ports {ROIC_DOUT_N[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_out2_cpu_clk_wiz_0_0] -clock_fall -min -add_delay 0.000 [get_ports {ROIC_DOUT_P[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_out2_cpu_clk_wiz_0_0] -clock_fall -max -add_delay 1.000 [get_ports {ROIC_DOUT_P[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_out2_cpu_clk_wiz_0_0] -min -add_delay 0.000 [get_ports {ROIC_DOUT_P[*]}]
set_input_delay -clock [get_clocks VIRTUAL_clk_out2_cpu_clk_wiz_0_0] -max -add_delay 1.000 [get_ports {ROIC_DOUT_P[*]}]
...
-group [get_clocks -of_objects [get_pins SYNTH.GEN_CPU_14.CPU_INST/mig_7series_0/u_cpu_mig_7series_0_1_mig/u_ddr3_infrastructure/gen_mmcm.mmcm_i/CLKOUT0]] \
-group [get_clocks -of_objects [get_pins U0_TI_TFT_TOP/U0_TI_CLOCK_MANAGER/CLK_GEN/inst/plle2_adv_inst/CLKOUT1]] \
-group [get_clocks -of_objects [get_pins SYNTH.GEN_CPU_14.CPU_INST/clk_wiz_0/inst/CLK_CORE_DRP_I/clk_inst/mmcm_adv_inst/CLKOUT0]] \
...
-group [get_clocks SYNTH.G_rxaui_10G.RXAUI_INST/U0/rxaui_block_i/gt0_wrapper_i/gtxe2_i/TXOUTCLK] \
-group [get_clocks VIRTUAL_clk_out2_cpu_clk_wiz_0_0] \
