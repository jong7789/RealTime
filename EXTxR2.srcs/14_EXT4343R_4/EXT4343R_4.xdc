...
## █▀█ █▀█ █ █▀▀
## █▀▄ █▄█ █ █▄▄
#set_property PACKAGE_PIN P23  [get_ports {ROIC_DCLK_P[0]}]; # ROIC_DCLK1_2_P  
#set_property PACKAGE_PIN R21  [get_ports {ROIC_DCLK_P[1]}]; # ROIC_DCLK1_5_P 
#set_property PACKAGE_PIN Y22  [get_ports {ROIC_DCLK_P[2]}]; # ROIC_DCLK1_8_P 
#set_property PACKAGE_PIN AC23 [get_ports {ROIC_DCLK_P[3]}]; # ROIC_DCLK1_11_P 

#set_property PACKAGE_PIN U22  [get_ports {ROIC_FCLK_P[0]}]; # ROIC_FCLK1_1_P 
#set_property PACKAGE_PIN W23  [get_ports {ROIC_FCLK_P[1]}]; # ROIC_FCLK1_12_P
#set_property PACKAGE_PIN U24  [get_ports {ROIC_FCLK_P[2]}]; # ROIC_FCLK1_17_P

#set_property PACKAGE_PIN M25  [get_ports {ROIC_DOUT_P[0]}] ; # ROIC_DOUTA1_1_P 
#set_property PACKAGE_PIN P24  [get_ports {ROIC_DOUT_P[1]}] ; # ROIC_DOUTA1_2_P 
#set_property PACKAGE_PIN T22  [get_ports {ROIC_DOUT_P[2]}] ; # ROIC_DOUTA1_3_P 
#set_property PACKAGE_PIN N26  [get_ports {ROIC_DOUT_P[3]}] ; # ROIC_DOUTA1_4_P 
#set_property PACKAGE_PIN R25  [get_ports {ROIC_DOUT_P[4]}] ; # ROIC_DOUTA1_5_P 
#set_property PACKAGE_PIN T24  [get_ports {ROIC_DOUT_P[5]}] ; # ROIC_DOUTA1_6_P 
#set_property PACKAGE_PIN V23  [get_ports {ROIC_DOUT_P[6]}] ; # ROIC_DOUTA1_7_P 
#set_property PACKAGE_PIN Y25  [get_ports {ROIC_DOUT_P[7]}] ; # ROIC_DOUTA1_8_P 
#set_property PACKAGE_PIN AA25 [get_ports {ROIC_DOUT_P[8]}] ; # ROIC_DOUTA1_9_P 
#set_property PACKAGE_PIN W25  [get_ports {ROIC_DOUT_P[9]}] ; # ROIC_DOUTA1_10_P
#set_property PACKAGE_PIN Y23  [get_ports {ROIC_DOUT_P[10]}]; # ROIC_DOUTA1_11_P
#set_property PACKAGE_PIN AD23 [get_ports {ROIC_DOUT_P[11]}]; # ROIC_DOUTA1_12_P
...
## set_property PACKAGE_PIN B26 [get_ports TP_1]
#set_property PACKAGE_PIN AE17 [get_ports tb_alignreq]
#set_property PACKAGE_PIN AF17 [get_ports tb_aligndone]

## █▀▀ ▄▀█ ▀█▀ █▀▀
## █▄█ █▀█ ░█░ ██▄
#set_property PACKAGE_PIN H23 [get_ports {GATE_SHIFT_CLK1L}];     # F_CPV1L 
#set_property PACKAGE_PIN D25 [get_ports {GATE_SHIFT_CLK1R}];     # F_CPV1R 
#set_property PACKAGE_PIN H24 [get_ports {GATE_SHIFT_CLK2L}];     # F_CPV2L 
#set_property PACKAGE_PIN D24 [get_ports {GATE_SHIFT_CLK2R}];     # F_CPV2R 
#set_property PACKAGE_PIN E23 [get_ports {GATE_START_PULSE1[0]}]; # F_DIO1_6
#set_property PACKAGE_PIN E26 [get_ports {GATE_START_PULSE1[1]}]; # F_DIO1_5
#set_property PACKAGE_PIN E25 [get_ports {GATE_START_PULSE1[2]}]; # F_DIO1_4
#set_property PACKAGE_PIN F25 [get_ports {GATE_START_PULSE1[3]}]; # F_DIO1_3
#set_property PACKAGE_PIN G25 [get_ports {GATE_START_PULSE1[4]}]; # F_DIO1_2
#set_property PACKAGE_PIN G26 [get_ports {GATE_START_PULSE1[5]}]; # F_DIO1_1
#set_property PACKAGE_PIN A17 [get_ports {GATE_START_PULSE1[6]}]; # F_DIO1_7
#set_property PACKAGE_PIN A18 [get_ports {GATE_START_PULSE1[7]}]; # F_DIO1_8
#set_property PACKAGE_PIN A19 [get_ports {GATE_START_PULSE1[8]}]; # F_DIO1_9
#set_property PACKAGE_PIN D23 [get_ports {GATE_START_PULSE2[0]}]; # F_DIO2_6
#set_property PACKAGE_PIN E22 [get_ports {GATE_START_PULSE2[1]}]; # F_DIO2_5
#set_property PACKAGE_PIN D21 [get_ports {GATE_START_PULSE2[2]}]; # F_DIO2_4
#set_property PACKAGE_PIN E20 [get_ports {GATE_START_PULSE2[3]}]; # F_DIO2_3
#set_property PACKAGE_PIN F22 [get_ports {GATE_START_PULSE2[4]}]; # F_DIO2_2
#set_property PACKAGE_PIN E21 [get_ports {GATE_START_PULSE2[5]}]; # F_DIO2_1
#set_property PACKAGE_PIN B19 [get_ports {GATE_START_PULSE2[6]}]; # F_DIO2_7
#set_property PACKAGE_PIN C18 [get_ports {GATE_START_PULSE2[7]}]; # F_DIO2_8
#set_property PACKAGE_PIN C19 [get_ports {GATE_START_PULSE2[8]}]; # F_DIO2_9  
#set_property PACKAGE_PIN C24 [get_ports {GATE_OUT_EN1L}] ;       # F_OE1L 
#set_property PACKAGE_PIN H26 [get_ports {GATE_OUT_EN1R}] ;       # F_OE1R 
#set_property PACKAGE_PIN G21 [get_ports {GATE_OUT_EN2L}] ;       # F_OE2L 
#set_property PACKAGE_PIN G24 [get_ports {GATE_OUT_EN2R}] ;       # F_OE2R 
#set_property PACKAGE_PIN G22 [get_ports {GATE_ALL_OUT}]  ;       # F_XONL 
#set_property PACKAGE_PIN H22 [get_ports {GATE_ALL_OUT_R}];       # F_XONR 
#set_property PACKAGE_PIN D20 [get_ports {GATE_CONFIG[0]}]; # F_INDL/R
#set_property PACKAGE_PIN J26 [get_ports {GATE_CONFIG[1]}]; # F_FB
#set_property PACKAGE_PIN D26 [get_ports {GATE_CONFIG[2]}]; # F_UD
#set_property PACKAGE_PIN K22 [get_ports {GATE_VGH_RST}]; # VGH_FLK Output - Low : VGH , High : GND (Analog S/W) 
## set_property PACKAGE_PIN [get_ports {F_NBIAS_CTRL}]; 
...
###########################
## 220609 for 1616 twinkle noise at roic 0num
...
set_property PACKAGE_PIN E15 [get_ports F_GPIO1]
set_property PACKAGE_PIN G17 [get_ports F_GPIO2]
set_property PACKAGE_PIN E18 [get_ports F_GPIO3]
set_property PACKAGE_PIN D18 [get_ports F_GPIO4]
set_property PACKAGE_PIN F15 [get_ports {PWR_EN[5]}];
set_property PACKAGE_PIN G15 [get_ports {PWR_EN[6]}];
set_property PACKAGE_PIN D15 [get_ports {PWR_EN[7]}];
set_property PACKAGE_PIN D16 [get_ports {PWR_EN[8]}];
...
set_property IOSTANDARD LVCMOS25 [get_ports {F_ROIC_SDO[0]}]
set_property IOSTANDARD LVCMOS25 [get_ports {F_ROIC_SDO[1]}]
set_property IOSTANDARD LVCMOS25 [get_ports {F_ROIC_SDO[2]}]
set_property IOSTANDARD LVCMOS25 [get_ports {F_ROIC_SYNC[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {FLASH_D[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {FLASH_D[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {FLASH_D[2]}]
...
create_clock -period 5.000 -name {ROIC_DCLK_P[0]} -waveform {0.000 2.500} [get_ports {ROIC_DCLK_P[0]}]
create_clock -period 5.000 -name {ROIC_DCLK_P[1]} -waveform {0.000 2.500} [get_ports {ROIC_DCLK_P[1]}]
create_clock -period 5.000 -name {ROIC_DCLK_P[2]} -waveform {0.000 2.500} [get_ports {ROIC_DCLK_P[2]}]
create_clock -period 5.000 -name {ROIC_DCLK_P[3]} -waveform {0.000 2.500} [get_ports {ROIC_DCLK_P[3]}]
...
#220408mbh
# synchonous - source #25091214
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[0]}] -clock_fall -min -add_delay 0.5 [get_ports {ROIC_DOUT_N[*]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[0]}] -clock_fall -max -add_delay 2.0 [get_ports {ROIC_DOUT_N[*]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[0]}] -min -add_delay 0.5 [get_ports {ROIC_DOUT_N[*]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[0]}] -max -add_delay 2.0 [get_ports {ROIC_DOUT_N[*]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[1]}] -clock_fall -min -add_delay 0.5 [get_ports {ROIC_DOUT_N[*]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[1]}] -clock_fall -max -add_delay 2.0 [get_ports {ROIC_DOUT_N[*]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[1]}] -min -add_delay 0.5 [get_ports {ROIC_DOUT_N[*]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[1]}] -max -add_delay 2.0 [get_ports {ROIC_DOUT_N[*]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[2]}] -clock_fall -min -add_delay 0.5 [get_ports {ROIC_DOUT_N[*]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[2]}] -clock_fall -max -add_delay 2.0 [get_ports {ROIC_DOUT_N[*]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[2]}] -min -add_delay 0.5 [get_ports {ROIC_DOUT_N[*]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[2]}] -max -add_delay 2.0 [get_ports {ROIC_DOUT_N[*]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[3]}] -clock_fall -min -add_delay 0.5 [get_ports {ROIC_DOUT_N[*]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[3]}] -clock_fall -max -add_delay 2.0 [get_ports {ROIC_DOUT_N[*]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[3]}] -min -add_delay 0.5 [get_ports {ROIC_DOUT_N[*]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[3]}] -max -add_delay 2.0 [get_ports {ROIC_DOUT_N[*]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[0]}] -clock_fall -min -add_delay 0.5 [get_ports {ROIC_DOUT_P[0] ROIC_DOUT_P[1] ROIC_DOUT_P[2]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[0]}] -clock_fall -max -add_delay 2.0 [get_ports {ROIC_DOUT_P[0] ROIC_DOUT_P[1] ROIC_DOUT_P[2]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[0]}] -min -add_delay 0.5 [get_ports {ROIC_DOUT_P[0] ROIC_DOUT_P[1] ROIC_DOUT_P[2]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[0]}] -max -add_delay 2.0 [get_ports {ROIC_DOUT_P[0] ROIC_DOUT_P[1] ROIC_DOUT_P[2]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[1]}] -clock_fall -min -add_delay 0.5 [get_ports {ROIC_DOUT_P[3] ROIC_DOUT_P[4] ROIC_DOUT_P[5]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[1]}] -clock_fall -max -add_delay 2.0 [get_ports {ROIC_DOUT_P[3] ROIC_DOUT_P[4] ROIC_DOUT_P[5]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[1]}] -min -add_delay 0.5 [get_ports {ROIC_DOUT_P[3] ROIC_DOUT_P[4] ROIC_DOUT_P[5]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[1]}] -max -add_delay 2.0 [get_ports {ROIC_DOUT_P[3] ROIC_DOUT_P[4] ROIC_DOUT_P[5]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[2]}] -clock_fall -min -add_delay 0.5 [get_ports {ROIC_DOUT_P[6] ROIC_DOUT_P[7] ROIC_DOUT_P[8]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[2]}] -clock_fall -max -add_delay 2.0 [get_ports {ROIC_DOUT_P[6] ROIC_DOUT_P[7] ROIC_DOUT_P[8]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[2]}] -min -add_delay 0.5 [get_ports {ROIC_DOUT_P[6] ROIC_DOUT_P[7] ROIC_DOUT_P[8]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[2]}] -max -add_delay 2.0 [get_ports {ROIC_DOUT_P[6] ROIC_DOUT_P[7] ROIC_DOUT_P[8]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[3]}] -clock_fall -min -add_delay 0.5 [get_ports {ROIC_DOUT_P[9] ROIC_DOUT_P[10] ROIC_DOUT_P[11]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[3]}] -clock_fall -max -add_delay 2.0 [get_ports {ROIC_DOUT_P[9] ROIC_DOUT_P[10] ROIC_DOUT_P[11]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[3]}] -min -add_delay 0.5 [get_ports {ROIC_DOUT_P[9] ROIC_DOUT_P[10] ROIC_DOUT_P[11]}]
#set_input_delay -clock [get_clocks {ROIC_DCLK_P[3]}] -max -add_delay 2.0 [get_ports {ROIC_DOUT_P[9] ROIC_DOUT_P[10] ROIC_DOUT_P[11]}]

set_input_delay -clock [get_clocks {ROIC_DCLK_P[0]}] -clock_fall -min -add_delay 0.1 [get_ports {ROIC_DOUT_P[0] ROIC_DOUT_P[1] ROIC_DOUT_P[2]}]
set_input_delay -clock [get_clocks {ROIC_DCLK_P[0]}] -clock_fall -max -add_delay 0.4 [get_ports {ROIC_DOUT_P[0] ROIC_DOUT_P[1] ROIC_DOUT_P[2]}]
set_input_delay -clock [get_clocks {ROIC_DCLK_P[0]}] -min -add_delay 0.1 [get_ports {ROIC_DOUT_P[0] ROIC_DOUT_P[1] ROIC_DOUT_P[2]}]
set_input_delay -clock [get_clocks {ROIC_DCLK_P[0]}] -max -add_delay 0.4 [get_ports {ROIC_DOUT_P[0] ROIC_DOUT_P[1] ROIC_DOUT_P[2]}]
set_input_delay -clock [get_clocks {ROIC_DCLK_P[1]}] -clock_fall -min -add_delay 0.1 [get_ports {ROIC_DOUT_P[3] ROIC_DOUT_P[4] ROIC_DOUT_P[5]}]
set_input_delay -clock [get_clocks {ROIC_DCLK_P[1]}] -clock_fall -max -add_delay 0.4 [get_ports {ROIC_DOUT_P[3] ROIC_DOUT_P[4] ROIC_DOUT_P[5]}]
set_input_delay -clock [get_clocks {ROIC_DCLK_P[1]}] -min -add_delay 0.1 [get_ports {ROIC_DOUT_P[3] ROIC_DOUT_P[4] ROIC_DOUT_P[5]}]
set_input_delay -clock [get_clocks {ROIC_DCLK_P[1]}] -max -add_delay 0.4 [get_ports {ROIC_DOUT_P[3] ROIC_DOUT_P[4] ROIC_DOUT_P[5]}]
set_input_delay -clock [get_clocks {ROIC_DCLK_P[2]}] -clock_fall -min -add_delay 0.1 [get_ports {ROIC_DOUT_P[6] ROIC_DOUT_P[7] ROIC_DOUT_P[8]}]
set_input_delay -clock [get_clocks {ROIC_DCLK_P[2]}] -clock_fall -max -add_delay 0.4 [get_ports {ROIC_DOUT_P[6] ROIC_DOUT_P[7] ROIC_DOUT_P[8]}]
set_input_delay -clock [get_clocks {ROIC_DCLK_P[2]}] -min -add_delay 0.1 [get_ports {ROIC_DOUT_P[6] ROIC_DOUT_P[7] ROIC_DOUT_P[8]}]
set_input_delay -clock [get_clocks {ROIC_DCLK_P[2]}] -max -add_delay 0.4 [get_ports {ROIC_DOUT_P[6] ROIC_DOUT_P[7] ROIC_DOUT_P[8]}]
set_input_delay -clock [get_clocks {ROIC_DCLK_P[3]}] -clock_fall -min -add_delay 0.1 [get_ports {ROIC_DOUT_P[9] ROIC_DOUT_P[10] ROIC_DOUT_P[11]}]
set_input_delay -clock [get_clocks {ROIC_DCLK_P[3]}] -clock_fall -max -add_delay 0.4 [get_ports {ROIC_DOUT_P[9] ROIC_DOUT_P[10] ROIC_DOUT_P[11]}]
set_input_delay -clock [get_clocks {ROIC_DCLK_P[3]}] -min -add_delay 0.1 [get_ports {ROIC_DOUT_P[9] ROIC_DOUT_P[10] ROIC_DOUT_P[11]}]
set_input_delay -clock [get_clocks {ROIC_DCLK_P[3]}] -max -add_delay 0.4 [get_ports {ROIC_DOUT_P[9] ROIC_DOUT_P[10] ROIC_DOUT_P[11]}]

set_clock_groups -asynchronous -group [get_clocks {clk_out1_cpu_clk_wiz_0_0}] -group [get_clocks {ROIC_DCLK_P[0]}]
set_clock_groups -asynchronous -group [get_clocks {clk_out1_cpu_clk_wiz_0_0}] -group [get_clocks {ROIC_DCLK_P[1]}]
set_clock_groups -asynchronous -group [get_clocks {clk_out1_cpu_clk_wiz_0_0}] -group [get_clocks {ROIC_DCLK_P[2]}]
set_clock_groups -asynchronous -group [get_clocks {clk_out1_cpu_clk_wiz_0_0}] -group [get_clocks {ROIC_DCLK_P[3]}]
...
-group [get_clocks {ROIC_DCLK_P[3]}];
#v2
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets diff_proc1_dclk[0].u_BUFG_roic_clk__0]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets diff_proc1_dclk[1].u_BUFG_roic_clk__0]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets diff_proc1_dclk[2].u_BUFG_roic_clk__0]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets diff_proc1_dclk[3].u_BUFG_roic_clk__0]
set_property CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN [get_nets U0_TI_TFT_TOP/U0_TI_LVDS_RX/oroic_clk_sel[0]]
set_property CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN [get_nets U0_TI_TFT_TOP/U0_TI_LVDS_RX/oroic_clk_sel[1]]
set_property CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN [get_nets U0_TI_TFT_TOP/U0_TI_LVDS_RX/oroic_clk_sel[2]]
set_property CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN [get_nets U0_TI_TFT_TOP/U0_TI_LVDS_RX/oroic_clk_sel[3]]

#create_clock -period 2.5 -name clk_ref_400 [get_nets GEV_CPU/cpu_i/sdram_0/u_cpu_sdram_0_0_mig/u_iodelay_ctrl/clk_ref_300_400_en.clk_ref_400.u_bufg_clk_ref_400/O]
create_clock -period 2.5 -name clk_ref_400 [get_nets GEV_CPU/cpu_i/sdram_0/u_cpu_sdram_0_0_mig/iodelay_ctrl_rdy[1]]
create_clock -period 2.5 -name clk_ref_400a [get_nets GEV_CPU/cpu_i/sdram_0/u_cpu_sdram_0_0_mig/u_iodelay_ctrl/clk_ref_300_400_en.clk_ref_400.u_bufg_clk_ref_400_n_0]
#set_property DONT_TOUCH true [get_nets GEV_CPU/cpu_i/sdram_0/u_cpu_sdram_0_0_mig/u_iodelay_ctrl/clk_ref_300_400_en.clk_ref_400.u_bufg_clk_ref_400_n_0]
#GEV_CPU/cpu_i/sdram_0/u_cpu_sdram_0_0_mig/u_iodelay_ctrl/idelayctrl_gen_1.u_idelayctrl_300_400_0
#ERROR: [DRC RTSTAT-2] Partially routed nets: 1 net(s) are partially routed. The problem bus(es) and/or net(s) are 
#GEV_CPU/cpu_i/sdram_0/u_cpu_sdram_0_0_mig/u_iodelay_ctrl/clk_ref_300_400_en.clk_ref_400.u_bufg_clk_ref_400_n_0.
#GEV_CPU/cpu_i/sdram_0/u_cpu_sdram_0_0_mig/u_iodelay_ctrl/idelayctrl_gen_1.u_idelayctrl_300_400_0
#ERROR: [DRC RTSTAT-2] Partially routed nets: 1 net(s) are partially routed. The problem bus(es) and/or net(s) are GEV_CPU/cpu_i/sdram_0/u_cpu_sdram_0_0_mig/u_iodelay_ctrl/clk_ref_300_400_en.clk_ref_400.u_bufg_clk_ref_400_n_0.
